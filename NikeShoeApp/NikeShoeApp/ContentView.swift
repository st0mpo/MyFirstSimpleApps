...
//  NikeShoeApp
//
//  Created by Александр Истомин on 23.09.2020.
//
            ...
            ZStack {
                ...
                VStack {
                    ...
                    VStack(alignment: .leading, spacing: 5) {
                        ...
                        Text("The Nike Air Huarache 07 WW is the b-ball OG with the look know best: crisp leather, bold colours and the perfect amount of flash to make you shine. Featuring Nike Worldwide graphics throughthout, it lets you celebrate the unity of sports in legendary style.")
...
struct  CustomShape : Shape {
    func path(in rect: CGRect) -> Path {
        ...
        let path = UIBezierPath(roundedRect: rect, byRoundingCorners: [.topLeft], cornerRadii: CGSize(width: 85, height: 8))
